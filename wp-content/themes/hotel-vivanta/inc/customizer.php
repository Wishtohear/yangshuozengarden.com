...
$wp_customize->add_setting('hotel_vivanta_theme_options[youtube]',
	array(
		'type' => 'option',
		'default' => $hotel_vivanta_options['youtube'],
		'sanitize_callback' => 'hotel_vivanta_sanitize_url',
	)
);
$wp_customize->add_control('hotel_vivanta_theme_options[youtube]',
	array(
		'label' => esc_html__('Youtube Link', 'hotel-vivanta'),
		'type' => 'text',
		'section' => 'banner_section',
		'settings' => 'hotel_vivanta_theme_options[youtube]',
	)
);

$wp_customize->add_setting('hotel_vivanta_theme_options[pinterest]',
	array(
		'type' => 'option',
		'default' => $hotel_vivanta_options['pinterest'],
		'sanitize_callback' => 'hotel_vivanta_sanitize_url',
	)
);
$wp_customize->add_control('hotel_vivanta_theme_options[pinterest]',
	array(
		'label' => esc_html__('Pinterest Link', 'hotel-vivanta'),
		'type' => 'text',
		'section' => 'banner_section',
		'settings' => 'hotel_vivanta_theme_options[pinterest]',
	)
);

$wp_customize->add_setting('hotel_vivanta_theme_options[whatsapp]',
	array(
		'type' => 'option',
		'default' => $hotel_vivanta_options['whatsapp'],
		'sanitize_callback' => 'hotel_vivanta_sanitize_url',
	)
);
$wp_customize->add_control('hotel_vivanta_theme_options[whatsapp]',
	array(
		'label' => esc_html__('Whatsapp Link', 'hotel-vivanta'),
		'type' => 'text',
		'section' => 'banner_section',
		'settings' => 'hotel_vivanta_theme_options[whatsapp]',
	)
);

$wp_customize->add_setting('hotel_vivanta_theme_options[email]',
	array(
		'type' => 'option',
		'default' => $hotel_vivanta_options['email'],
		'sanitize_callback' => 'hotel_vivanta_sanitize_url',
	)
);
$wp_customize->add_control('hotel_vivanta_theme_options[email]',
	array(
		'label' => esc_html__('Email Link', 'hotel-vivanta'),
		'type' => 'text',
		'section' => 'banner_section',
		'settings' => 'hotel_vivanta_theme_options[email]',
	)
);
...
$wp_customize->add_section(
	'copyright_section',
	array(
		'title' => esc_html__( 'Copyright Section','hotel-vivanta' ),
		'panel'=>'theme_options',
		'capability'=>'edit_theme_options',
	)
);

$wp_customize->add_setting('hotel_vivanta_theme_options[copyright_text]',
	array(
		'default' => $hotel_vivanta_options['copyright_text'],
		'type' => 'option',
		'sanitize_callback' => 'sanitize_text_field'
	)
);

$wp_customize->add_control('hotel_vivanta_theme_options[copright_text]',
	array(
		'label' => esc_html__('Copyright Text', 'hotel-vivanta'),
		'type' => 'text',
		'section' => 'copyright_section',
		'settings' => 'hotel_vivanta_theme_options[copyright_text]',
	)
);
}
