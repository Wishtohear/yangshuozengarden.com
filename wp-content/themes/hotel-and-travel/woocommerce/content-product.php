...
<li <?php wc_product_class( '', $product ); ?>>
    ...
    <div class="custom-cart-btn">
				<?php
				/**
				 * Hook: hotel_and_travel_loop_add_to_cart.
				 *
				 * @hooked woocommerce_template_loop_add_to_cart - 10
				 */
				do_action( 'hotel_and_travel_loop_add_to_cart' );
				?>
    </div>
    ...
    <div class="hover-area">
        <div class="action-buttons">
            <?php
                if( class_exists('YITH_WCWL') && function_exists('hotel_and_travel_pro_textdomain') ) {
                ...
                if( class_exists('YITH_WOOCOMPARE') && function_exists('hotel_and_travel_pro_textdomain')) {	
