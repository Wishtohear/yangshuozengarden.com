<?php
/**
 * Hotel and Travel Customizer Radio Image Control.
 * 
 * @package Best_Shop
*/
...
if( ! class_exists( 'hotel_and_travel_Radio_Image_Control' ) ){
	/**
	 * Radio Image control (modified radio).
    */
	class hotel_and_travel_Radio_Image_Control extends WP_Customize_Control {
		...
		public function enqueue() {            
            wp_enqueue_style( 'hotel-and-travel-radio-image', get_template_directory_uri() . '/inc/controlset/radioimg/radio-image.css', null );
            wp_enqueue_script( 'hotel-and-travel-radio-image', get_template_directory_uri() . '/inc/controlset/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
