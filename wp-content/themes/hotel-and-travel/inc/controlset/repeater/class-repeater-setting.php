<?php
/**
 * Hotel and Travel Repeater Customizer Setting.
 * 
 * @package Best_Shop
*/
...
if ( ! class_exists( 'hotel_and_travel_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class hotel_and_travel_Repeater_Setting extends WP_Customize_Setting {
