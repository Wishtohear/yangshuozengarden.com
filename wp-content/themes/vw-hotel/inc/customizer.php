...
function vw_hotel_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'vw_hotel_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options <a class="go-pro-btn" target="blank" href="https://www.buywptemplates.com/products/wordpress-hotel-theme">GET PRO</a>','vw-hotel'),
		'priority'   => null,
		'panel' => 'vw_hotel_homepage_panel'
	) );
	...
	'choices' => array(
      '0' =>  esc_attr( __('0','vw-hotel')),
      '0.1' =>  esc_attr( __('0.1','vw-hotel')),
      '0.2' =>  esc_attr( __('0.2','vw-hotel')),
      '0.3' =>  esc_attr( __('0.3','vw-hotel')),
      '0.4' =>  esc_attr( __('0.4','vw-hotel')),
      '0.5' =>  esc_attr( __('0.5','vw-hotel')),
      '0.6' =>  esc_attr( __('0.6','vw-hotel')),
      '0.7' =>  esc_attr( __('0.7','vw-hotel')),
      '0.8' =>  esc_attr( __('0.8','vw-hotel')),
      '0.9' =>  esc_attr( __('0.9','vw-hotel'))
	),'active_callback' => 'vw_hotel_default_slider'
	));
   ...
   $wp_customize->add_setting('vw_hotel_slider_image_overlay_color', array(
	...
	$wp_customize->add_section('vw_hotel_aboutus_section',array(
		...
		'description' => __('For more options of about section <a class="go-pro-btn" target="blank" href="https://www.buywptemplates.com/products/wordpress-hotel-theme">GET PRO</a>','vw-hotel'),
		'panel' => 'vw_hotel_homepage_panel',
	));
	...
	$wp_customize->add_control('vw_hotel_hotel_room_btn',array(
		'description' => "<a class='go-pro' target='_blank' href=".esc_url(VW_HOTEL_BUY_NOW).">More Info</a>",
		'section'=> 'vw_hotel_hotel_room',
		'type'=> 'hidden'
	));
	...
	$wp_customize->add_section('vw_hotel_footer',array(
		...
		'description' => __('For more options of footer section <a class="go-pro-btn" target="blank" href="https://www.buywptemplates.com/products/wordpress-hotel-theme">GET PRO</a>','vw-hotel'),
		'panel' => 'vw_hotel_homepage_panel',
	));
	...
	$wp_customize->add_setting( 'vw_hotel_related_toggle_postdate',array(
	    'default' => 1,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'vw_hotel_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Hotel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hotel_related_toggle_postdate',array(
	    'label' => esc_html__( 'Show / Hide Post Date','vw-hotel' ),
	    'section' => 'vw_hotel_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_hotel_related_postdate_icon',array(
	    'default' => 'fas fa-calendar-alt',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Hotel_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_hotel_related_postdate_icon',array(
	    'label' => __('Add Post Date Icon','vw-hotel'),
	    'transport' => 'refresh',
	    'section' => 'vw_hotel_related_posts_settings',
	    'setting' => 'vw_hotel_related_postdate_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_hotel_related_toggle_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_hotel_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Hotel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hotel_related_toggle_author',array(
		'label' => esc_html__( 'Show / Hide Author','vw-hotel' ),
		'section' => 'vw_hotel_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_hotel_related_author_icon',array(
	    'default' => 'fas fa-user',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Hotel_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_hotel_related_author_icon',array(
	    'label' => __('Add Author Icon','vw-hotel'),
	    'transport' => 'refresh',
	    'section' => 'vw_hotel_related_posts_settings',
	    'setting' => 'vw_hotel_related_author_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_hotel_related_toggle_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_hotel_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Hotel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hotel_related_toggle_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','vw-hotel' ),
		'section' => 'vw_hotel_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_hotel_related_comments_icon',array(
	    'default' => 'fa fa-comments',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Hotel_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_hotel_related_comments_icon',array(
	    'label' => __('Add Comments Icon','vw-hotel'),
	    'transport' => 'refresh',
	    'section' => 'vw_hotel_related_posts_settings',
	    'setting' => 'vw_hotel_related_comments_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_hotel_related_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_hotel_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Hotel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hotel_related_toggle_time',array(
		'label' => esc_html__( 'Show / Hide Time','vw-hotel' ),
		'section' => 'vw_hotel_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_hotel_related_time_icon',array(
	    'default' => 'fas fa-clock',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Hotel_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_hotel_related_time_icon',array(
	    'label' => __('Add Time Icon','vw-hotel'),
	    'transport' => 'refresh',
	    'section' => 'vw_hotel_related_posts_settings',
	    'setting' => 'vw_hotel_related_time_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_hotel_related_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_hotel_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Hotel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hotel_related_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-hotel' ),
		'section' => 'vw_hotel_related_posts_settings'
  	)));

  	$wp_customize->add_setting( 'vw_hotel_related_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_hotel_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_hotel_related_image_box_shadow', array(
		'label'       => esc_html__( 'Related post Image Box Shadow','vw-hotel' ),
		'section'     => 'vw_hotel_related_posts_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  	...
  	$wp_customize->add_setting('vw_hotel_related_button_text',array(
		'default'=> esc_html__('Read More','vw-hotel'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_hotel_related_button_text',array(
	...
	$wp_customize->add_setting( 'vw_hotel_singlepost_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_hotel_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_hotel_singlepost_image_box_shadow', array(
		'label'       => esc_html__( 'Single post Image Box Shadow','vw-hotel' ),
		'section'     => 'vw_hotel_single_blog_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
    ...
    $wp_customize->add_setting( 'vw_hotel_grid_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_hotel_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Hotel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_hotel_grid_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-hotel' ),
		'section' => 'vw_hotel_grid_layout_settings'
  	)));
	...
	$wp_customize->add_setting( 'vw_hotel_grid_featured_image_border_radius', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_hotel_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_hotel_grid_featured_image_border_radius', array(
		'label'       => esc_html__( 'Grid Featured Image Border Radius','vw-hotel' ),
		'section'     => 'vw_hotel_grid_layout_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'vw_hotel_grid_featured_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_hotel_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_hotel_grid_featured_image_box_shadow', array(
		'label'       => esc_html__( 'Grid Featured Image Box Shadow','vw-hotel' ),
		'section'     => 'vw_hotel_grid_layout_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
    ...
    $wp_customize->add_setting('vw_hotel_breadcrumbs_alignment',array(
        'default' => 'Left',
        'sanitize_callback' => 'vw_hotel_sanitize_choices'
	));
	$wp_customize->add_control('vw_hotel_breadcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Breadcrumbs Alignment','vw-hotel'),
        'section' => 'vw_hotel_left_right',
        'choices' => array(
            'Left' => __('Left','vw-hotel'),
            'Right' => __('Right','vw-hotel'),
...
final class VW_Hotel_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(new VW_Hotel_Customize_Section_Pro($manager,'vw_hotel_upgrade_pro_link',array(
			...
			'pro_url'  => esc_url('https://www.buywptemplates.com/products/wordpress-hotel-theme'),
		)));
		...
		$manager->add_section(new VW_Hotel_Customize_Section_Pro($manager,'vw_hotel_get_started_link',array(
			...
			'pro_url'  => esc_url('https://demos.buywptemplates.com/demo/docs/free-hotel/'),
		)));
		...
		$manager->add_section(new VW_Hotel_Customize_Section_Pro($manager,'vw_hotel_get_bundle_link',array(
			...
			'pro_url'  => esc_url('https://www.buywptemplates.com/products/wp-theme-bundle')
		)));
	}
