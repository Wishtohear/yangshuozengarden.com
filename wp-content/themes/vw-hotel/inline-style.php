<?php
	...
	$vw_hotel_grid_featured_image_border_radius = get_theme_mod('vw_hotel_grid_featured_image_border_radius', 0);
	if($vw_hotel_grid_featured_image_border_radius != false){
		$vw_hotel_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img{';
			$vw_hotel_custom_css .='border-radius: '.esc_attr($vw_hotel_grid_featured_image_border_radius).'px;';
		$vw_hotel_custom_css .='}';
	}

	$vw_hotel_grid_featured_image_box_shadow = get_theme_mod('vw_hotel_grid_featured_image_box_shadow',0);
	if($vw_hotel_grid_featured_image_box_shadow != false){
		$vw_hotel_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img, #content-vw img{';
			$vw_hotel_custom_css .='box-shadow: '.esc_attr($vw_hotel_grid_featured_image_box_shadow).'px '.esc_attr($vw_hotel_grid_featured_image_box_shadow).'px '.esc_attr($vw_hotel_grid_featured_image_box_shadow).'px #cccccc;';
		$vw_hotel_custom_css .='}';
	}

	$vw_hotel_related_image_box_shadow = get_theme_mod('vw_hotel_related_image_box_shadow',0);
	if($vw_hotel_related_image_box_shadow != false){
		$vw_hotel_custom_css .='.related-post .box-image img{';
			$vw_hotel_custom_css .='box-shadow: '.esc_attr($vw_hotel_related_image_box_shadow).'px '.esc_attr($vw_hotel_related_image_box_shadow).'px '.esc_attr($vw_hotel_related_image_box_shadow).'px #cccccc;';
		$vw_hotel_custom_css .='}';
	}
	...
	if($vw_hotel_resp_menu_toggle_btn_bg_color != false){
		$vw_hotel_custom_css .='.toggle-nav i,.sidenav .closebtn{';
	...
	if($vw_hotel_featured_image_box_shadow != false){
		$vw_hotel_custom_css .='.service-image img,  #content-vw img{';
	...
	$vw_hotel_singlepost_image_box_shadow = get_theme_mod('vw_hotel_singlepost_image_box_shadow',0);
	if($vw_hotel_singlepost_image_box_shadow != false){
		$vw_hotel_custom_css .='.feature-box img{';
			$vw_hotel_custom_css .='box-shadow: '.esc_attr($vw_hotel_singlepost_image_box_shadow).'px '.esc_attr($vw_hotel_singlepost_image_box_shadow).'px '.esc_attr($vw_hotel_singlepost_image_box_shadow).'px #cccccc;';
		$vw_hotel_custom_css .='}';
	}
	...
	$vw_hotel_breadcrumbs_alignment = get_theme_mod( 'vw_hotel_breadcrumbs_alignment','Left');
    if($vw_hotel_breadcrumbs_alignment == 'Left'){
    	$vw_hotel_custom_css .='@media screen and (min-width:768px) {';
		$vw_hotel_custom_css .='.breadcrumbs{';
			$vw_hotel_custom_css .='text-align:start;';
		$vw_hotel_custom_css .='}}';
	}else if($vw_hotel_breadcrumbs_alignment == 'Center'){
		$vw_hotel_custom_css .='@media screen and (min-width:768px) {';
		$vw_hotel_custom_css .='.breadcrumbs{';
			$vw_hotel_custom_css .='text-align:center;';
		$vw_hotel_custom_css .='}}';
	}else if($vw_hotel_breadcrumbs_alignment == 'Right'){
		$vw_hotel_custom_css .='@media screen and (min-width:768px) {';
		$vw_hotel_custom_css .='.breadcrumbs{';
			$vw_hotel_custom_css .='text-align:end;';
		$vw_hotel_custom_css .='}}';
	}
