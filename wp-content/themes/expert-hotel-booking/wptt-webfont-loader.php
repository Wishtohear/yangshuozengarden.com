...
if ( ! class_exists( 'Expert_Hotel_Booking_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Expert_Hotel_Booking_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Expert_Hotel_Booking_WPTT_WebFont_Loader( $url );
