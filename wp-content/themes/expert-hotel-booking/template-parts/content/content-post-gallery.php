...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
    <?php
        ...
        $expert_hotel_booking_post_id = get_the_ID(); // Add this line to get the post ID
        $expert_hotel_booking_gallery_shortcode = get_post_gallery();

        if (!empty($expert_hotel_booking_gallery_shortcode)) {
            // Display the gallery
            echo '<div class="embedded-gallery">' . do_shortcode($expert_hotel_booking_gallery_shortcode) . '</div>';
        }
    ?>
