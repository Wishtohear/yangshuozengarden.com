...
<section id="slider">
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
          ...
          <div class="carousel-caption">
            <div class="inner_carousel">
              ...
              <div class="more-btn">
                <a href="<?php the_permalink(); ?>"><?php esc_html_e('BOOK NOW','resort-hotel-booking'); ?></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
      ...
      <span class="screen-reader-text"><?php esc_html_e('Previous','resort-hotel-booking'); ?></span>
    </a>
    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
      <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-angle-right"></i></span>
      <span class="screen-reader-text"><?php esc_html_e('Next','resort-hotel-booking'); ?></span>
    </a> 
  </div>
