...
$theme = wp_get_theme();
define( 'HOTELONE_THEME_NAME', $theme->get('Name') );
...
if( !function_exists( 'hotelone_scripts' ) ):
	...
	function hotelone_scripts() {
		...
		wp_enqueue_style( 'lightgallery', get_template_directory_uri() .'/css/lightgallery.css', array(), $version );		
		...
		wp_enqueue_script( 'lightgallery-js', get_template_directory_uri() . '/js/lightgallery.js', array(), $version, true );
